...
Namespace SP_BBDD
    Public Class Soporte_CancelacionInformeMedico
        Public Sub New()
            MyBase.New()
        End Sub

        Public Overridable Sub soporte_CancelarInformeMedico(ByVal connection As System.Data.SqlClient.SqlConnection, _
            ...
            Else
                ...
                If (transaccion Is Nothing) Then
                    If (connection.State = System.Data.ConnectionState.Closed) Then
                        ...
                        'Abrir Conexion
                    End If
                    cmd = New System.Data.SqlClient.SqlCommand("Soporte_CancelacionInformeMedico", connection)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                Else
                    cmd = New System.Data.SqlClient.SqlCommand("Soporte_CancelacionInformeMedico", connection, transaccion)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                End If
