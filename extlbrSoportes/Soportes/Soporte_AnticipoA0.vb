...
Namespace SP_BBDD
    Public Class Soporte_AnticipoA0
        Public Sub New()
            MyBase.New()
        End Sub

        Public Overridable Sub soporte_AnticipoA0(ByVal connection As System.Data.SqlClient.SqlConnection, _
            ...
            Else
                ...
                If (transaccion Is Nothing) Then
                    If (connection.State = System.Data.ConnectionState.Closed) Then
                        ...
                        'Abrir Conexion
                    End If
                    cmd = New System.Data.SqlClient.SqlCommand("Soporte_AnticipoA0", connection)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                Else
                    cmd = New System.Data.SqlClient.SqlCommand("Soporte_AnticipoA0", connection, transaccion)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                End If
