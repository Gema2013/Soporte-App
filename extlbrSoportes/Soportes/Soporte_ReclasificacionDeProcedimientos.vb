...
Namespace SP_BBDD
    Public Class Soporte_ReclasificacionDeProcedimientos
        Public Sub New()
            MyBase.New()
        End Sub

        Public Overridable Sub soporte_ReclasificacionDeProcedimientos(ByVal connection As System.Data.SqlClient.SqlConnection, _
            ...
            Else
                ...
                If (transaccion Is Nothing) Then
                    If (connection.State = System.Data.ConnectionState.Closed) Then
                        ...
                        'Abrir Conexion
                    End If
                    cmd = New System.Data.SqlClient.SqlCommand("Soporte_ReclasificacionDeProcedimientos", connection)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                Else
                    cmd = New System.Data.SqlClient.SqlCommand("Soporte_ReclasificacionDeProcedimientos", connection, transaccion)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                End If
                ...
                Dim _tipoCaja As System.Data.SqlClient.SqlParameter = New System.Data.SqlClient.SqlParameter
                _tipoCaja.ParameterName = "@tipoCaja"
                _tipoCaja.Size = 8
                _tipoCaja.Value = TipoCaja
                cmd.Parameters.Add(_tipoCaja)
